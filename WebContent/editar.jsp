			...
			<div class="row">
				<div class="col-lg-12">
					<div class="intro-text">
						<span class="name">Atualizar</span>
			...
			<div class="row">
				<div class="col-lg-8 col-lg-offset-2">
					...
					<form action="JediServlet?cmd=atualizar" method="post">
						<table class="table table-striped">
							...
							<tr>
								...
								<td>
									<select
									class="form-control"
									required name="txtClasse" value="${jedi.classe}">
						...
						<tr>
							<th colspan="2">
								<input type="submit" class="btn btn-primary btn-lg" name="btAtualizar" value="Salvar" />
							</th>
						</tr>	
					</table>
				</form>	
