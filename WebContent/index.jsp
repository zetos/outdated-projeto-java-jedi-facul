...
<body id="page-top" class="index">
	...
	<nav class="navbar navbar-default navbar-fixed-top">
		<div class="container">
			...
			<a class="navbar-brand" href="JediServlet?cmd=principal">Star Wars</a>
		</div>
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-lg-4 col-lg-offset-2">
				<p><strong>Nome</strong> - Digite o nome do Jedi completo. Caso seja desconhecido digite o nome pelo qual ele é conhecido.<br><br>
					<strong>Espécie</strong> - Digite a espécie do Jedi. Caso seja de uma espécia ainda desconhecida ou não tenha certeza você pode encontrar mais informações no vasto banco de dados do templo Jedi em Coruscant.<br><br>
					<strong>Planeta Natal</strong> - Digite o planeta natal do Jedi. Na ausência dessa informação o planeta em que o Jedi teve seu primeiro registro feito servira.<br><br>
					<strong>Sexo</strong> - Digite o sexo do Jedi.<br><br>
					<strong>Idade</strong> - Digite a idade do Jedi. Caso essa informação seja desconhecida, a biblioteca do templo jedi pode lhê ajudar a chegar em aproximações de acordo com a espécia. Droides podem facilitar na pesquisa. Nesses casos dados não exatos são aceitos.
				</p>
			</div>
			<div class="col-lg-4">
				<p>
					<strong>MidiChlorians</strong> - Midi-chlorians são formas de vida microscópicas inteligentes que vivem dentro das células seus numeros definem sua ligação com a força. Uma análise de sangue lhe dara os números de Midi-chlorians encontrados no jedi.<br><br>
					<strong>Classe</strong> - Selecione a Classe de Jedi. Jedis iniciantes geralmente serão registrado como Iniciados ou Padawans.<br><br>
					<strong>Status</strong> - Digite o Status quo desse Jedi. Em caso de desaparecimento, morte, ou alguma outra situação esse é o lugar onde isso deverá ser excplicado.
				</p>
			</div>
		</div>
	</div>
