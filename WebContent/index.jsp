 ...
 <div class="row">
    <div class="col-lg-12">
        ...
        <table class="table table-striped">
            ...
            <c:forEach var="lista" items="${ requestScope.jediList }">
            <tr>
                <td>${lista.nome}</td>
                <td>${lista.especie}</td>
                <td>${lista.planeta}</td>
...
<div class="row control-group">
    <div class="form-group col-xs-12 floating-label-form-group controls">
        <label>Status</label>
        <textarea rows="2" class="form-control" placeholder="Status do Jedi" id="status" required data-validation-required-message="Por favor entre com o status do jedi."></textarea>
        <p class="help-block text-danger"></p>
    </div>
</div>
<br>
