...
<div class="row control-group">
    <div class="form-group col-xs-12 floating-label-form-group controls">
        <label>Status</label>
        <textarea rows="3" class="form-control" placeholder="Status do Jedi" id="status" required data-validation-required-message="Por favor entre com o status do jedi."></textarea>
        <p class="help-block text-danger"></p>
    </div>
</div>
<div class="row control-group">
